...
#   load_dotenv()
def generate_embeds(file_path: str = os.getenv("INPUTPDF_PATH")):
      # Step 1: Parse PDF
      #file_path = "/content/fundamental_rights_upsc.pdf"
      #file_path = os.getenv("INPUTPDF_PATH")
      ...
      vector_store = Chroma.from_documents(
          document_chunks,
          embeddings,
          collection_name= os.getenv("COL_NAME"),
